...
public class Static01 {
    ...
    //static variable has another name: class variable because we
    //static things is attached to .. not objects

    public int iCounter = 0;
    //to create instance valuable, do not use static keyword
    ...
    public static void main(String[] args) {
        ...
        add(3, 5); //the real values used in method called arguments
    }

    public static int add(int a, int b){ //the variable like "in a" and "int b" are called parameters
