...
public class Q01 {
    ...
    public static void main(String[] args){
        ...
        /*
            A company decided to give bonus of 5% to employee if his/her year of service is 5 and more than 5 years.
        ...
        */
        ...
        if (year<0 || salary<0){
            ...
            System.out.println("You should work: " + (5-year) + " years(s)");
        } else {
