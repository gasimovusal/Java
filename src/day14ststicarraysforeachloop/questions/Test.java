package day14ststicarraysforeachloop.questions;
...
public class Test {
    ...
    static int counter = 1000; //static variable; changeds for every object
    String studentId; //instance variable

    public Test() { //constractor because no return type
