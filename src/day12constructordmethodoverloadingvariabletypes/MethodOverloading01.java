package day12constructordmethodoverloadingvariabletypes;
...
public class MethodOverloading01 {
    ...
    //if you use a method inside the main method use "static" keyword between the acces modifier and the "return type"
    public static int add(int a, int b) { //user enter a=4, b=8 ;; int will be 8 after adding 3 and 5
        return a + b; // passing 3 and 5 ==> 3+5=8
    }
